...
<ons-card>
    <div class='title'>Ajuste de Posicion</div>
  <div class='content'><p>Mueve el slider hasta la posicion deseada o usa las flechas para ajustar la posicion de la pantalla.</p></div>
  <ons-row>
...
<template id='settings.html'>
  ...
  <ons-card>
    ...
    <p>
    <ol>
      <li>Usa las flechas y el boton stop para navegar hasta la posicion mas Baja</li>
      <li>Pincha en el boton START </li>
      <li>Usa las flechas y el boton down para navegar hasta la posicion mas Alta</li>
      <li>Pincha en el boton MAX </li>
      <li> Calibracion Completada!</li>
    </ol>
    </p>
  </div>
  </ons-card>
